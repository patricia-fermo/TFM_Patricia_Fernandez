...
temp_discovery1$POS<-paste(temp_discovery1$chr, temp_discovery1$bpos, sep=":")
...
temp_discovery3<-dataDiscovery[,c("snpid", "chr", "bpos", "a1", "a2", "freq", "mtag_beta", "mtag_se", "mtag_pval", "POS")]
colnames(temp_discovery3)<-c("SNP_ID", "CHR", "BP", "A1", "A2", "FRQ", "BETA", "SE", "P", "SNP")
...
setwd("/home/nodotea/PATRICIA/Objetivos/Calculos_PRS")
system2("./plink", args=c("--bfile EUGEI_WP2_Case_control_noMHC_filtered_CLUMPED", "--score LNL_ISO_SCORE.txt", "--q-score-file LNL_ISO_P.txt", "--q-score-range Q_RANGES.txt", "--out LNL_ISO_PRS_SCORE"))
...
LNL_ISO$decile <- ntile(LNL_ISO$SCORE_S9, 10) ### Asignar el umbral más significativo
