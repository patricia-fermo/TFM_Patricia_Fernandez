...
dataDiscovery <- read.table('LNL_ukbb_2018.txt', header=TRUE, stringsAsFactors = FALSE)  ## 8862761 variantes
...
setwd("/home/nodotea/PATRICIA/Objetivos/Calculos_PRS")
system2("./plink", args=c("--bfile EUGEI_WP6_Case_control_noMHC_filtered_CLUMPED", "--score LNL_SCORE.txt", "--q-score-file LNL_P.txt", "--q-score-range Q_RANGES.txt", "--out LNL_PRS_SCORE"))
...
LNL$decile <- ntile(LNL$SCORE_S3, 4) ### Asignar el umbral más significativo
