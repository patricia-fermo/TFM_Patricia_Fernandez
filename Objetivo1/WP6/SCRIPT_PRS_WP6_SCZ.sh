...
dataDiscovery <- read.table('PGC3_SCZ_wave3.european.autosome.public.v3.vcf.tsv', header=TRUE, stringsAsFactors = FALSE)  ## 7659767 variantes
...
setwd("/home/nodotea/PATRICIA/Objetivos/Calculos_PRS")
system2("./plink", args=c("--bfile EUGEI_WP6_Case_control_noMHC_filtered_CLUMPED", "--score SCZ_SCORE.txt", "--q-score-file SCZ_P.txt", "--q-score-range Q_RANGES.txt", "--out SCZ_PRS_SCORE"))
...
### G) JUNTAR COVARIABLES DE ANÁLISIS Y PRS A DISTINTOS UMBRALES DE P VALOR.
